...
namespace GenshinCourse.Controllers
{
    ...
    {
        private GenshinCourse_dbEntities db = new GenshinCourse_dbEntities();
        ...
        public ActionResult Create([Bind(Include = "id,first_name,last_name,nic,course_id,batch_id,telno")] registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,first_name,last_name,nic,course_id,batch_id,telno")] registration registration)
        {
            if (ModelState.IsValid)
            {
